...
type SessionService interface {
	...
	SearchKnowledge(ctx context.Context, knowledgeBaseIDs []string, knowledgeIDs []string, query string, metadataFilters types.MetadataFilters) ([]*types.SearchResult, error)
